...
class ManaPro_FilterColors_Model_Observer {
	...
	public function processUpdate($observer) {
		...
		switch ($object->getEntityName()) {
			...
			case 'mana_filters/filter2_store':
                ...
                if (!Mage::helper('mana_db')->hasOverriddenValue($object, $values, 14)) {
                    $object->setImageNormal($values['image_normal']);
                }
                if (!Mage::helper('mana_db')->hasOverriddenValue($object, $values, 15)) {
                    $object->setImageSelected($values['image_selected']);
                }
                if (!Mage::helper('mana_db')->hasOverriddenValue($object, $values, 16)) {
                    $object->setImageNormalHovered($values['image_normal_hovered']);
                }
                if (!Mage::helper('mana_db')->hasOverriddenValue($object, $values, 17)) {
                ...
                if (!Mage::helper('mana_db')->hasOverriddenValue($object, $values, 21)) {
	...
	public function addEditedData($observer) {
		...
		switch ($object->getEntityName()) {
			case 'mana_filters/filter2':
			case 'mana_filters/filter2_store':
				Mage::helper('mana_db')->updateDefaultableField($object, 'image_width', 6, $fields, $useDefault);
				Mage::helper('mana_db')->updateDefaultableField($object, 'image_height', 7, $fields, $useDefault);
				Mage::helper('mana_db')->updateDefaultableField($object, 'image_border_radius', 8, $fields, $useDefault);
                Mage::helper('mana_db')->updateDefaultableField($object, 'image_normal', 14, $fields, $useDefault);
                Mage::helper('mana_db')->updateDefaultableField($object, 'image_selected', 15, $fields, $useDefault);
                Mage::helper('mana_db')->updateDefaultableField($object, 'image_normal_hovered', 16, $fields, $useDefault);
                Mage::helper('mana_db')->updateDefaultableField($object, 'image_selected_hovered', 17, $fields, $useDefault);
                Mage::helper('mana_db')->updateDefaultableField($object, 'state_width', 18, $fields, $useDefault);
                Mage::helper('mana_db')->updateDefaultableField($object, 'state_height', 19, $fields, $useDefault);
                Mage::helper('mana_db')->updateDefaultableField($object, 'state_border_radius', 20, $fields, $useDefault);
                Mage::helper('mana_db')->updateDefaultableField($object, 'state_image', 21, $fields, $useDefault);
				break;
            case 'mana_filters/filter2_value':
            case 'mana_filters/filter2_value_store':
                Mage::helper('mana_db')->updateDefaultableField($object, 'color', 2, $fields, $useDefault);
                Mage::helper('mana_db')->updateDefaultableField($object, 'normal_image', 3, $fields, $useDefault);
                Mage::helper('mana_db')->updateDefaultableField($object, 'selected_image', 4, $fields, $useDefault);
                Mage::helper('mana_db')->updateDefaultableField($object, 'normal_hovered_image', 5, $fields, $useDefault);
                Mage::helper('mana_db')->updateDefaultableField($object, 'selected_hovered_image', 6, $fields, $useDefault);
                Mage::helper('mana_db')->updateDefaultableField($object, 'state_image', 7, $fields, $useDefault);
                break;
		}
	}
	/**
